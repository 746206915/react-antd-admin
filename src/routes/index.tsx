...
const AppUserManagementPage = lazy(() => import(/* webpackChunkName: "app-users" */ '@/pages/user/management'));
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<AppUserManagementPage />} titleId="title.user.management" />,
      },
      {
        path: '*',
